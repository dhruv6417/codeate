...
//       </div>
//       <div classname={`${styles.back1} ${styles.head12}`} >
...
//        <option value="" disabled selected>Enter Graduation Year</option>
//        <option value="text">2022</option>
//        <option value="text">2023</option>
//        <option value="text">2024</option>
//        </select>  
//        <textarea id="story" name="story"
//           rows="5" cols="33" placeholder="Why do you want to be a Student Ambassador ?">
//       </textarea>

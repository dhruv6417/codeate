...
{/*          <input type="radio" id="css" name="fav_language" value="Mentee"/>
         <label for="css">Mentee</label> */}
        </form>
       ...
       <option value="" disabled selected>Enter years of work experience</option>
       ...
       <select className="graduation" id="grad">
       <option value="" disabled selected>Enter years of mentoring experience</option>
       <option value="text">0</option>
       <option value="text">1</option>
       <option value="text">2</option>
       <option value="text">3</option>
       ...
       <select className="graduation" id="grad">
       <option value="" disabled selected>Enter your domain</option>
       ...
       <input type="text" placeholder="Enter Linedln URL"/> 
       <textarea id="story" name="story"
          rows="5" cols="33" placeholder="Why do you want to be a Mentee ?">
      </textarea>
      <div className={styles.last}>
          <h5>By submitting, I agree to terms & conditions and privacy policy</h5>
        </div>

        ...
        <div className={styles.wrapper}>
            <div className={styles.privacy__container}>
                ...
                <div className={styles.policy__para}>
                    ...
                    <h1 className={styles.subtitle}>Interpretation</h1>
                    <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                    <h1 className={styles.subtitle}>Definitions</h1>
                    ...
                    <h1 className={styles.subheading}>Collecting and Using Your Personal Data</h1>
                    <h2 className='lg:text-xl text-md mb-3'  styles={{marginBottom:'10px', fontSize: '84px'}}>Types of Data Collected</h2>
                    <h3 className={styles.subheading}>Personal Data</h3>
                    ...
                    <h1 className={styles.subtitle}>Tracking Technologies and Cookies</h1>
                    <p>
                        We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:
                    </p>
                    <h1 className={styles.subtitle}>Third Party Privacy Policies </h1>
                    <ul>
                        <li>
                    ...
                    <h1 className={styles.subtitle}>Use of Your Personal Data</h1>
                    <p>
                    ...
                    <h1 className={styles.subtitle}>Retention of Your Personal Data</h1>
                    <p>
                    ...
                    <h1 className={styles.subheading}>Disclosure of Your Personal Data</h1>
                    <h2 className={styles.subtitle}>Business Transactions</h2>
                    <p>
                        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                    </p>
                    <h2 className={styles.subtitle}>Law enforcement</h2>
                    <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                    <h2 className={styles.subtitle}>Others legal requirements	</h2>
                    ...
                    <h1 className={styles.subtitle}>Security of Your Personal Data</h1>
                    <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                    <h1 className={styles.subtitle}>Detailed Information on the Processing of Your Personal Data</h1>
                    <p>The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>
                    <h1 className={styles.subtitle}>Children &apos;s Policy</h1>
                    ...
                    <h1 className={styles.subtitle}>Links to Other Websites</h1>
                    <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&apos;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                    <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                    <h1 className={styles.subtitle}>Changes to this Privacy Policy</h1>
